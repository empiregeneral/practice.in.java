 ...
 * 可见设计该题目的人非常的“狡诈”，让一般的程序员完全在无数次提交但是最终显示WA的循环状态中打转。
 * 从测试的角度来看就要求在阅读题目需求的同时设计测试用例设计考虑的非常全面，这样才能写出更加严谨
 * 和不容易出WA的代码。
 * -----------------------------------------------------------------------------------
 * 让我想起了季怡故意卖关子后面来坑下属的事情，交代任务不完全或者说没头没尾(Like as Zjo 1115中描述的测试用例)，
 * 又开始忽悠下属去做事情马上要结果，总之做的好做不好都要怒斥一遍。
